...
urlpatterns = [
	...
	# start servicereport wizard
	url(r'^servicereport/select_ls/$', views.ServiceReportSelectLS, name='ServiceReportSelectLSForm'),
	url(r'^servicereport/(?P<pk>\d+)/general_info/$', views.ServiceReportGeneralInfo, name='ServiceReportGeneralInfoForm'),
	url(r'^servicereport/(?P<pk>\d+)/select_seals/$', views.ServiceReportSelectSeals, name='ServiceReportSelectSealsForm'),
]
